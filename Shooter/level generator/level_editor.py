...
for x in range(TILE_TYPES):
	img = pygame.image.load(f'./level generator/img/tile/{x}.png').convert_alpha()
	img = pygame.transform.scale(img, (TILE_SIZE, TILE_SIZE))
	img_list.append(img)

save_img = pygame.image.load('./level generator/img/save_btn.png').convert_alpha()
load_img = pygame.image.load('./level generator/img/load_btn.png').convert_alpha()
...
while run:
	...
	if save_button.draw(screen):
		...
		with open(f'./lvl/level{level}_data.csv', 'w', newline='') as csvfile:

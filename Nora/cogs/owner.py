...
class Owner(commands.Cog):
    ...
    async def load(self, ctx, *, cog=None):
        try:
            ...
            e = discord.Embed(title=f"{cog}.py was loaded <:python:596577462335307777>", color=discord.Color.dark_blue())
            em = await ctx.send(embed=e)
    ...
    async def r(self, ctx, *, cog=None):
        try:
            ...
            e = discord.Embed(title=f"{cog}.py was reloaded <:python:596577462335307777>", color=discord.Color.dark_blue())
            em = await ctx.send(embed=e)
            await em.add_reaction('<a:nryep:826064891253096488>')
    ...
    async def unload(self, ctx, *, cog=None):
        try:
            ...
            e = discord.Embed(title=f"{cog}.py was unloaded", color=discord.Color.dark_blue())
            em = await ctx.send(embed=e)
            await em.add_reaction('<a:nryep:826064891253096488>')

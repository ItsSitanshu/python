...
class Mod(commands.Cog):
    ...
    async def clear(self, ctx, amount=5):
        ...
        clrer = ctx.author
        em = discord.Embed(title=f"Deleted {amount}", description=f"{clrer} deleted {amount} messages")
    ...
    async def _unban(self, ctx, member: discord.Object, *, reason = None):
        ...
        try:
            ...
            unbanned_embed = discord.Embed(title = "Success!", description = f"Successfully unbanned {member}", Color = discord.Color.green())
